...
document.getElementById("logoutbutton").addEventListener('mouseover', () =>{
  document.getElementById("logoutbutton").style.background='white';
}) 

document.getElementById("logoutbutton").addEventListener('mouseout', () =>{
  document.getElementById("logoutbutton").style.background='';
}) 